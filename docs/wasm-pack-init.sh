...
WASM_PACK_VERSION=0.4.2
UPDATE_ROOT="https://github.com/rustwasm/wasm-pack/releases/download/v$WASM_PACK_VERSION"
...
main() {
    ...
    local _tardir="wasm-pack-v${WASM_PACK_VERSION}-${_arch}"
